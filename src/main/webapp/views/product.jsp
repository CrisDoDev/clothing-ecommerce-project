				...
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<c:forEach items="${listCategory}" var="c">
						<a href="product?cid=${c.id}"
							class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 ${tag == c.id ? 'how-active1' : ''}">
							${c.name} </a>
					</c:forEach>
				</div>
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text"
							name="search-product" placeholder="Search" id="search-input"
							autocomplete="off">
					</div>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="detail?pid=${p.id}"
										...
										${p.name} </a> <span class="stext-105 cl3"> <fmt:formatNumber
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img
						src="${pageContext.request.contextPath}/images/icons/icon-close.png"
						alt="CLOSE">
				</button>
				<div class="row">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							<h4 class="mtext-105 cl2 js-name-detail p-b-14 modal-name">Product
								Name</h4>
							...
							<form action="cart" method="post" class="p-t-33">
								<input type="hidden" name="action" value="add"> <input
									type="hidden" name="id" class="modal-id" value="">
								...
								<div class="flex-w flex-r-m p-b-10">
									...
									<div class="size-204 respon6-next">
										<div class="rs1-select2 bor8 bg0">
											<%-- ID cho AJAX --%>
											<select class="js-select2" name="size" id="modal-size-select"
												required>
