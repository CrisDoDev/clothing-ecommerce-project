                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="images/${product.imageUrl}">
                                    <div class="wrap-pic-w pos-relative">
                                        ...
                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/${product.imageUrl}">
                                            ...
                                            <select class="js-select2" name="size" required>
                                                ...
                                                <c:forEach items="${listSizes}" var="s">
                                                    <c:choose>
														...
														<option value="${s.size}" data-max="${s.stockQuantity}">                                                                Size ${s.size} (Còn: ${s.stockQuantity})
                                                            </option>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <option disabled>
                                                                Size ${s.size} (Hết hàng)
                                                            </option>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </c:forEach>
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    <div class="size-204 flex-w flex-m respon6-next">
                                        <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                            ...
                                            <input id="num-product-input" class="mtext-104 cl3 txt-center num-product" type="number" name="quantity" value="1" min="1">
